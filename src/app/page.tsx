...
const CutoutLetter = ({ char, rot, bg, textCol, delay }: { char: string, rot: number, bg: string, textCol: string, delay: number }) => (
  <motion.div 
    ...
    className={`inline-block flex-shrink-0 ${bg} ${textCol} font-marker filter-torn text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl px-3 py-2 md:px-4 md:py-2 mx-0.5 md:mx-1 shadow-[4px_4px_0px_rgba(0,0,0,0.1)] cursor-pointer`}
  >
    {char}
  </motion.div>
);
    ...
    <main className="min-h-screen text-slate-800 overflow-x-hidden relative" style={{ perspective: "1200px" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex-shrink-0 flex items-center gap-4">
              <img src="/fulshear-logo.png" alt="Fulshear High School" className="h-16 w-auto object-contain filter-torn bg-white p-1" />
              <img src="/deca-logo.png" alt="DECA Logo" className="h-14 w-auto object-contain bg-white p-1 rounded-sm shadow-sm border border-slate-200 filter-torn" />
              <span className="font-heading font-black text-4xl tracking-tight hidden sm:block text-deca-navy pl-4 border-l-4 border-slate-300 border-dotted ml-2">Fulshear DECA</span>
            </div>
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-10 font-gochi text-4xl text-slate-700">
                ...
                <a href="#join" className="bg-deca-gold text-slate-900 font-sans text-lg hover:bg-yellow-400 px-8 py-3 rounded-sm font-bold shadow-[4px_4px_0px_#0f2040] transition-all transform hover:-translate-y-1 hover:shadow-[6px_6px_0px_#0f2040]">Join Now</a>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-center relative z-10">
            ...
            <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.8 }} className="flex flex-col sm:flex-row gap-8 justify-center">
              <a href="#join" className="px-12 py-6 bg-deca-navy text-white font-marker text-3xl shadow-[8px_8px_0px_#d4af37] hover:translate-y-1 hover:shadow-[3px_3px_0px_#d4af37] transition-all flex items-center justify-center gap-2 group transform -rotate-1 border-4 border-deca-navy">
                Join DECA <ArrowRight className="w-8 h-8 group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="#competitions" className="px-12 py-6 bg-white border-4 border-slate-800 text-slate-800 font-marker text-3xl shadow-[8px_8px_0px_#cbd5e1] hover:translate-y-1 hover:shadow-[3px_3px_0px_#cbd5e1] transition-all flex items-center justify-center transform rotate-1">
                Explore Events!
              </a>
            </motion.div>
          </div>
          ...
          <motion.div 
            ...
            className="hidden xl:block absolute -right-40 top-20 rotate-6 sticker bg-white w-80 shadow-2xl hover:z-50 hover:scale-110 transition-transform z-0"
          >
             ...
             <p className="font-gochi text-center py-6 text-4xl text-slate-700">Astros Game!</p>
          </motion.div>
          <motion.div 
            style={{ y: useTransform(scrollYProgress, [0, 0.3], [0, -80]) }}
            className="hidden xl:block absolute -left-40 bottom-10 -rotate-6 sticker bg-white w-96 shadow-2xl hover:z-50 hover:scale-110 transition-transform z-0"
          >
      ...
      <section id="competitions" className="py-32 relative overflow-hidden bg-[#fdfbf7]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className="text-7xl md:text-9xl font-marker text-slate-800 mb-6 relative z-10 transform -rotate-1" style={{textShadow: "6px 6px 0px white"}}>Competitive Events</h2>
            <p className="font-gochi text-6xl text-blue-600 mt-8 relative z-10">Over 50+ events to choose from!</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 perspective-[1000px]">
            {[
              ...
              <motion.div 
                ...
                className={`relative bg-white p-10 shadow-[14px_14px_0px_rgba(0,0,0,0.15)] border-t-[12px] ${category.border} border-x-4 border-b-4 border-slate-200 transition-transform duration-300 filter-torn-light`}
              >
                {/* Washi Tape */}
                ...
                <h3 className="text-5xl font-marker text-slate-800 mb-6 relative z-10">{category.title}</h3>
                <p className="text-slate-700 font-gochi text-4xl leading-relaxed relative z-10">{category.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="officers" className="py-32 relative overflow-hidden bg-blue-50/50 border-y-4 border-dashed border-slate-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="font-gochi text-7xl text-pink-500 mb-4 relative z-10 -rotate-3">Meet Our</h2>
            <h2 className="text-7xl md:text-9xl font-black font-marker text-slate-800 inline-block relative z-10 bg-white px-10 py-6 border-8 border-slate-800 shadow-[12px_12px_0px_#cbd5e1] rotate-1">OFFICER TEAM</h2>
          </motion.div>
            ...
            {[
              ...
              >
                <motion.div 
                  ...
                  className="sticker bg-white w-full max-w-[380px] aspect-[3/4] z-10 relative shadow-[14px_14px_30px_rgba(0,0,0,0.2)] border-4 border-slate-200 cursor-grab active:cursor-grabbing"
                >
                ...
                >
                  <div className="text-blue-600 font-bold text-lg uppercase tracking-widest mb-2 font-sans border-b-4 border-dashed border-blue-200 pb-2">{officer.role}</div>
                  <div className="text-slate-800 font-gochi text-6xl mt-4">{officer.name}</div>
                </motion.div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-32 mt-10 bg-[#e8e4d9] border-y-8 border-slate-800 relative shadow-inner">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="text-7xl md:text-9xl font-marker text-slate-800 mb-2 transform -rotate-1" style={{textShadow: "6px 6px 0px white"}}>Chapter Memories</h2>
          </motion.div>
            ...
            {[
              ...
              >
                ...
                <div className="p-6 text-center bg-yellow-50 mt-4 filter-torn border-2 border-yellow-200">
                  <p className="font-gochi text-4xl text-slate-800">{item.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <footer className="bg-deca-navy text-white pt-24 pb-16 text-center relative mt-20">
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-16">
            <img src="/fulshear-logo.png" className="h-28 filter brightness-0 invert" />
            <span className="font-marker text-5xl md:text-6xl text-yellow-400 tracking-wider">Fulshear High School DECA</span>
            <img src="/deca-logo.png" className="h-16 md:h-20 filter brightness-0 invert" />
          </div>
          ...
          <p className="text-blue-300 font-gochi text-4xl">
